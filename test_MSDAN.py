...
parser = argparse.ArgumentParser(description="MSDAN_Test")
# parser.add_argument("--logdir", type=str, default="logs/MSDAN6/", help='path to model and log files')
parser.add_argument("--logdir", type=str, default="logs/Rain100L/MSDAN/", help='path to model and log files')
...
parser.add_argument("--save_path", type=str, default="/home/r/works/derain_arxiv/release/results/MSDAN", help='path to save results')
...
def main():
    ...
    # Build model
    print('Loading model ...\n')
    model = MSDAN(opt.recurrent_iter, opt.use_GPU)
    print_network(model)
    if opt.use_GPU:
        model = model.cuda()
