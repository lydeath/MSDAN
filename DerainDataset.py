...
def prepare_data_RainTrain1000(data_path, patch_size, stride):
    # train
    print('process training data')
    input_path = os.path.join(data_path, 'inputTrain')
    target_path = os.path.join(data_path, 'targetTrain')
